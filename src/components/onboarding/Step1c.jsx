  ...
  return (
    <div className="space-y-8">
      <div className="text-center mb-10">
        ...
        <p className="text-[#706B67] text-lg font-medium">Two quick agreements and you're in.</p>
      </div>
        ...
        {!isEditMode && (
          <div className="flex items-start space-x-3">
            ...
            <Label htmlFor="agreeToTerms" className="text-[#1F1F1F] text-sm leading-relaxed cursor-pointer font-medium">
              I agree to the <Link to="/terms" className="text-[#C85A72] hover:underline" target="_blank">Terms of Service</Link>, <Link to="/privacy" className="text-[#C85A72] hover:underline" target="_blank">Privacy Policy</Link>, and <Link to="/community-guidelines" className="text-[#C85A72] hover:underline" target="_blank">Community Guidelines</Link> of Marryzen.
            </Label>
          </div>
        )}
      </div>
      ...
      {isRecaptchaEnabled && (
        <div className="text-xs text-[#706B67] text-center pt-2 pb-2 flex items-center justify-center gap-1 flex-wrap">
          ...
          <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-[#C85A72] hover:underline">Privacy Policy</a>
          <span>and</span>
          <a href="https://policies.google.com/terms" target="_blank" rel="noopener noreferrer" className="text-[#C85A72] hover:underline">Terms of Service</a>
          <span>apply.</span>
        </div>
      )}
