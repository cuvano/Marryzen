    ...
    <>
      <div className="space-y-10">
        <div className="text-center mb-10">
          ...
          <p className="text-brand-muted text-lg font-medium">Marryzen is strictly for people seeking serious marriage and lifelong partnership.</p>
          <p className="text-[#1F1F1F] text-sm mt-3 inline-flex items-center justify-center gap-2 font-semibold bg-[#FAF7F2] border border-[#E6DCD2] rounded-full px-4 py-1.5">
            <Shield size={14} className="text-brand-pink-strong"/>
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className={`text-sm ${isSelected ? 'text-[#1F1F1F]/80' : 'text-brand-muted'}`}>{goal.description}</div>
                    </div>
                  </div>
                </button>
              );
        ...
        <div className="space-y-6 pt-6 border-t border-[#F3E8D9]">
          <div className="flex items-start space-x-3">
            ...
            <Label htmlFor="confirmMarriageIntent" className="text-[#1F1F1F] text-sm font-medium cursor-pointer leading-relaxed">
              I confirm that I am joining Marryzen with the <span className="font-bold text-brand-pink-strong">Serious Intention of Marriage</span>, not casual dating or hookups.
            </Label>
          </div>
        ...
        />
        {dealbreakersSaving && (
          <p className="text-xs text-brand-muted mt-2 ml-2 text-center">Saving your preferences&hellip;</p>
        )}
