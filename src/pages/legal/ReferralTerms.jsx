    ...
    <div className="min-h-screen bg-[#FAF7F2]">
      <div className="max-w-4xl mx-auto p-4 md:p-8">
        <Button 
          ...
          className="mb-6 text-brand-muted hover:text-[#1F1F1F]"
        >
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <p className="text-sm text-brand-muted mt-2">Last updated: {new Date().toLocaleDateString()}</p>
          </CardHeader>
          <CardContent className="prose prose-sm max-w-none">
            <div className="space-y-6 text-[#1F1F1F]">
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2 text-brand-muted ml-4">
              ...
              <section>
                <h2 className="text-xl font-bold mb-3 flex items-center gap-2">
                  <Shield className="w-5 h-5 text-brand-pink-strong" />
                  Tracking Integrity
                </h2>
                <p className="text-brand-muted mb-4">
                  We track all referrals with the following information to ensure program integrity:
                </p>
                <ul className="list-disc list-inside space-y-2 text-brand-muted ml-4">
              ...
              <section>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-brand-muted flex-1">Your friend has signed up but their profile is not yet approved. Reward is locked until approval.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="px-2 py-1 rounded-full text-xs font-bold bg-green-100 text-green-800 mt-1">Completed</span>
                    <p className="text-brand-muted flex-1">Your friend's profile has been approved. Reward has been issued to both accounts.</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <span className="px-2 py-1 rounded-full text-xs font-bold bg-red-100 text-red-800 mt-1">Expired</span>
                    <p className="text-brand-muted flex-1">The referral did not result in a completed signup or the friend's profile was rejected.</p>
                  </div>
                </div>
              </section>
