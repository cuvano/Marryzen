...
import { Button } from '@/components/ui/button';import React, { useState, useEffect } from 'react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
                    ...
                    <DialogContent className="bg-slate-900 border-slate-800 text-slate-100 max-w-lg">
                      ...
                      <div className="space-y-4 py-2 max-h-[70vh] overflow-y-auto pr-2">
                        ...
                        <div>
                          ...
                          <textarea
                            className="w-full h-24 bg-slate-950 border border-slate-700 rounded p-2 text-sm mt-1 focus:outline-none focus:ring-1 focus:ring-slate-600"
                            placeholder="What did the user do wrong? What should they avoid? They will see this verbatim in their warning email."
                            value={warningMessage}
                            onChange={(e) => setWarningMessage(e.target.value)}
                          />
                        </div>
