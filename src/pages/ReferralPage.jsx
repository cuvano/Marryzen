...
const ReferralPage = () => {
  ...
  const shareMessage = `I've been on Marryzen - a dating app where everyone is ID-verified and actually looking for marriage. Thought of you. Here's a month free if you want to check it out: ${referralLink}`;
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] p-4 md:p-8">
      <div className="max-w-5xl mx-auto">
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-800">
                ...
                The referral status updates to "Completed" once their profile is verified.
                Rewards are issued within 24 hours of verification.
              </p>
            </div>
          </CardContent>
        </Card>

        {/* Enhancements block: native share + Your invites pipeline + trust line + FAQ */}
        <ReferralEnhancements
          referralLink={referralLink}
          shareCopy={shareMessage}
        />

        {/* Referral History (full table) â moved BELOW Your invites per design */}
        <Card className="mt-8">
        ...
        {/* Footer (Platform for Serious Marriage) â pinned to absolute bottom of page */}
